...
public static class OpenTelemetryConfiguration
{
        ...
        IConfiguration configuration)
    {
        ...
        var serviceName = otelConfig["ServiceName"] ?? "Product.Template.Api";
        ...
        services.AddOpenTelemetry()
            ...
            .WithTracing(tracingBuilder =>
            {
                ...
                tracingBuilder
                    ...
                    .AddSource("Product.Template.Api");
    ...
    /// </summary>
    public static readonly ActivitySource ActivitySource = new("Product.Template.Api");
}
